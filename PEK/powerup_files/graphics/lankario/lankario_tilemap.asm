;##################################################################################################
;# GFX set: Lankario (AKA Lankio AKA Weird Mario)
;# Author: Nintendo (Original), SubconsciousEye (Port)
;# Description: Default set for Weird Mario.
...
.tilemap
    ...
    db $10                  ; [10]      Diagonal
    db $11,$12,$13          ; [11-13]   Running up wall
    ...
    db $1F                  ; [1F]      Swinging on net, showing back
    db $20                  ; [20]      Mounted on Yoshi; Swinging on net, side
    db $21                  ; [21]      Turning around on Yoshi, facing camera; Swinging on net, facing camera; Going into a pipe on Yoshi
    ...
    db $1D                  ; [29]      Going into a pipe on Yoshi (Weird Crouch)
    ...
    db $FF                  ; [42]      Using P-Balloon (Small Mario, Unused)
    db $3B                  ; [43]      Using P-Balloon (Non-Small Mario, Used)
    db $25,$0F,$00          ; [44-46]   Copy of the spinjump poses (Non-Small Forms); Last byte is also a part of the Shrinking/Growing animation
    db $09                  ; [47]      Dummy scuttle frame, holding an item; Used to initiate animation
    db $2C,$2D              ; [48-49]   Part of scuttle frames, rising jump (0B)
    db $2E,$2F              ; [4A-4B]   Part of scuttle frames, falling (24)
    db $16,$3A              ; [4C-4D]   Part of Swimming Idle Animation
    db $17,$19              ; [4E-4F]   Part of Swimming Idle Animation, holding an item
    db $2A,$2B              ; [50-51]   Yoshi Rider Poses (Separate from Climbing); 20-21
...
.index_for_disp_index
    ...
    db $06                  ; [14]      Victory pose, on Yoshi
    db $00                  ; [15]      Climbing
    ...
    db $06,$06              ; [27-28]   Commanding Yoshi
    db $06                  ; [29]      Crouching on Yoshi; also used for going into a pipe
    ...
    db $00                  ; [47]      Dummy scuttle frame, holding an item; Used to initiate animation
    db $00,$00              ; [48-49]   Part of scuttle frames, rising jump (0B)
    db $00,$00              ; [4A-4B]   Part of scuttle frames, falling (24)
    db $00,$00              ; [4C-4D]   Part of Swimming Idle Animation
    db $00,$00              ; [4E-4F]   Part of Swimming Idle Animation, holding an item
    db $06,$06              ; [50-51]   Yoshi Rider Poses (Separate from Climbing); 20-21
...
.disp_index
    db $00,$08,$10,$18,$20,$28,$30,$38	;00-07
...
.x_disp
    ...
    dw $FFF8,$FFF8,$0008,$0008	;[30]	Yoshi (facing left)
    dw $0008,$0008,$FFF8,$FFF8	;[38]	Yoshi (facing right)
...
.y_disp
    ...
    ;below are free to use
    dw $0002,$0012,$0002,$0012	;[30]	Yoshi (facing left)
    dw $0002,$0012,$0002,$0012	;[38]	Yoshi (facing right)
