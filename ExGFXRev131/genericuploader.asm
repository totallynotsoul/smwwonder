...
L107:				; Example. Place this at the level(s) you want to upload to, in the level table above.
		dw $3800, $0082		; Example. Uploads ExGFX 200 to VRAM Address $6000 ($3000 * 2)
		dw $FFFF		; Example. Terminates the table.
