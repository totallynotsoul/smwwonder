;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; LM1.7x Tilemap Remapper Patch v1.2.1 (for LM1.91+)
; coded by edit1754
;
...
SetUpScreen_Hijack:
		...
		PLB			; restore DB
		JML $1FA45A		; jump back to custom screen setup subroutine
...
+		ORA.b #%00000001	; Afterwards in either case, set bit %00000001 (DMA transfer type)
		...
		JML $1FA485		; LM1.7 Stripe Hijack (the return JML is redirected near top of file)
