...
!HammerNumber = $01         ; Extended sprite number (from list.txt) of the hammer (hammer.asm).
...
SpriteCode:
    LDA #!dss_id_hammerbro
    %FindAndQueueGFXPage0()
    BCC .notloaded
    REP #$20
    LDA !dss_tile_buffer+3
    STA !dss_tile_buffer+5
    LDA !dss_tile_buffer+1
    STA !dss_tile_buffer+3
    SEP #$20
    LDA !dss_tile_buffer
    STA !dss_tile_buffer+2
...
-   LDA $00
    ...
    CLC : ADC $03
    TAX
    LDA .buffer_index,x                  ; tilemap determined by $1602,x.
    TAX
